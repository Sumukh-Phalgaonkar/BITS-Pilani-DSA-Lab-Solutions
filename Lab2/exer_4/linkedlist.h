...
/* deletes the first node in the list that contains the element = ele and returns it
If the element is not found it returns an error message saying element not
found. */
/* End of linkedlist.h */
